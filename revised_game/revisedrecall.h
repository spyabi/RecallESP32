/*
#ifndef REVISEDRECALL_H
#define REVISEDRECALL_H
// NOT IN USE
//might need #include <Arduino.h>
//class implementation
/*
class RevisedRecall {       // The class
  public:             // Access specifier
    int game_level;        // Attribute (int variable)
    Map map;  // Attribute (string variable)

    RevisedRecall(int game_level, Map map);
